"""
Django settings for firmas_pdf project.
...
WSGI_APPLICATION = 'firmas_pdf.wsgi.application'
...
# Directorio donde collectstatic colocará archivos estáticos para despliegues simples
